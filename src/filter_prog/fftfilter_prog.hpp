...
namespace FiltersProg
{
    ...
    class fftfilter_prog : public base
    {
        public:
             /**
             * @brief fftfilter_prog Creates an instance of the fftfilter_prog class
             * @param cmd The TCLAP::CmdLine which is used to add command line arguments
             */
            fftfilter_prog ( TCLAP::CmdLine& cmd) :
                base ( cmd ),
